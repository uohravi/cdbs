...
public class recover_education extends JFrame
{
	...
	String colhead[]={"BLOCK_CODE","VILLAGE_CODE","PANCHAYAT_CODE","EDUCATION_CODE","NO_OF_MALE_LITERATE","NO_OF_MALE_ILITERATE","NO_OF_FEMALE_LITERATE","NO_OF_FEMALE_ILITERATE","User","Status","Date of Modification"};
	Object data[][]=new Object[30][11];
	JTable table=new JTable(data,colhead);
	Cursor cr;
	
	public recover_education()
	{
		...
		title=new JLabel("Recover Education Information");
    	...
    	l1=new JLabel("Enter Education Code");
		...
		load();
         ...
         public void load()
         {
            ...
            try
            {
              ...
              rs=stat.executeQuery("select BLOCK_CODE,VILLAGE_CODE,PANCHAYAT_CODE,EDUCATION_CODE,NO_OF_MALE_LITERATE,NO_OF_MALE_ILITERATE,NO_OF_FEMALE_LITERATE,NO_OF_FEMALE_ILITERATE,User_NAME,Status,TO_CHAR(dt,'DD-MON-YYYY') from bkp_education order by block_code");
              while(rs.next())
              {
                str1=rs.getString(1);
                str2=rs.getString(2);
   	...
   	private class okListener implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			try
			{
				  str1=t1.getText();
				  tmp="update";
				  rs=stat.executeQuery("select BLOCK_CODE,VILLAGE_CODE,PANCHAYAT_CODE,NO_OF_MALE_LITERATE,NO_OF_MALE_ILITERATE,NO_OF_FEMALE_LITERATE,NO_OF_FEMALE_ILITERATE,Status from bkp_education where education_code='"+str1.trim()+"'");
                 rs.next();
                str2=rs.getString(1);
                str3=rs.getString(2);
                str4=rs.getString(3);
                ...
                {
                stat.executeUpdate("update education_INFO set block_code='"+str2+"',Village_code='"+str3+"',PANCHAYAT_CODE='"+str4+"',NO_OF_MALE_LITERATE='"+str5+"',NO_OF_MALE_ILITERATE='"+str6+"',NO_OF_FEMALE_LITERATE='"+str7+"',NO_OF_FEMALE_ILITERATE='"+str8+"' where education_code='"+str1.trim()+"'");
				stat.executeUpdate("delete from bkp_education where education_code='"+str1.trim()+"'");
				stat.executeUpdate("commit");
