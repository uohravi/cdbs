...
public class District_Details extends JFrame
{
	private JPanel p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,pmain;
	...
	public District_Details()
	{
		...
		t2.getDocument().addDocumentListener(new enteListener());
		...
		pmain.setLayout(new GridLayout(14,1));
	...
	private class enteListener implements DocumentListener
	{
	...
	{
		District_Details dd=new District_Details();
	}
}
