...
public class recover_school extends JFrame
{
	...
	String colhead[]={"BLOCK_CODE","VILLAGE_CODE","SCHOOL_NO","SCHOOL_NAME","SCHOOL_TYPE","NO_OF_STUDENT","NO_OF_TEACHER","HOD_NAME","User","Status","Date of Modification"};
	Object data[][]=new Object[30][11];
	JTable table=new JTable(data,colhead);
	Cursor cr;
	
	public recover_school()
	{
		...
		title=new JLabel("Recover School Information");
    	...
    	l1=new JLabel("Enter School Number");
		...
		load();
         ...
         public void load()
         {
            ...
            try
            {
              ...
              rs=stat.executeQuery("select BLOCK_CODE,VILLAGE_CODE,SCHOOL_NO,SCHOOL_NAME,SCHOOL_TYPE,NO_OF_STUDENT,NO_OF_TEACHER,HOD_NAME,User_NAME,Status,TO_CHAR(dt,'DD-MON-YYYY') from bkp_school order by block_code");
              while(rs.next())
              {
                str1=rs.getString(1);
                str2=rs.getString(2);
   	...
   	private class okListener implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			try
			{
				  str1=t1.getText();
				  tmp="update";
				  rs=stat.executeQuery("select BLOCK_CODE,VILLAGE_CODE,SCHOOL_NAME,SCHOOL_TYPE,NO_OF_STUDENT,NO_OF_TEACHER,HOD_NAME,Status from bkp_school where school_no='"+str1.trim()+"'");
                 rs.next();
                str2=rs.getString(1);
                str3=rs.getString(2);
                str4=rs.getString(3);
                ...
                {
                stat.executeUpdate("update school_INFO set block_code='"+str2+"',Village_code='"+str3+"',school_name='"+str4+"',school_type='"+str5+"',no_of_student='"+str6+"',no_of_teacher='"+str7+"',hod_name='"+str8+"' where school_no='"+str1.trim()+"'");
				stat.executeUpdate("delete from bkp_school where school_no='"+str1.trim()+"'");
				stat.executeUpdate("commit");
