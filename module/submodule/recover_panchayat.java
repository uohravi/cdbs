...
public class recover_panchayat extends JFrame
{
	...
	String colhead[]={"District_code","Subdivision_code","Block_code","Panchayat_code","Panchayat_name","estd","Surpanch_name","User_Name","Status","Date Of Modification"};
	Object data[][]=new Object[30][10];
	JTable table=new JTable(data,colhead);
	Cursor cr;
	
	public recover_panchayat()
	{
		...
		title=new JLabel("Recover Panchayat Information");
    	...
    	l1=new JLabel("Enter Panchayat_Code");
		...
		load();
         ...
         public void load()
         {
            ...
            try
            {
              ...
              rs=stat.executeQuery("select District_code,subdiv_code,block_code,panchayat_code,panchayat_name,TO_CHAR(estd,'DD-MON-YYYY'),surpanch_name,user_name,status,TO_CHAR(dt,'DD-MON-YYYY') from bkp_panchayat order by district_code");
              while(rs.next())
              {
                str1=rs.getString(1);
                str2=rs.getString(2);
   	...
   	private class okListener implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			try
			{
				  str1=t1.getText();
				  tmp="update";
				  rs=stat.executeQuery("select district_code,subdiv_code,block_code,panchayat_name,TO_CHAR(estd,'DD-MON-YYYY'),surpanch_name,status from bkp_panchayat where panchayat_code='"+str1.trim()+"'");
                 rs.next();
                str2=rs.getString(1);
                str3=rs.getString(2);
                str4=rs.getString(3);
				...
				stat.executeUpdate("update panchayat_master set district_code='"+str2+"',subdiv_CODE='"+str3+"',block_code='"+str4.trim()+"',panchayat_name='"+str5.trim()+"',estd='"+str6+"',surpanch_name='"+str7.trim()+"' where panchayat_code='"+str1.trim()+"'");
				stat.executeUpdate("delete from bkp_panchayat where panchayat_code='"+str1.trim()+"'");
				stat.executeUpdate("commit");
