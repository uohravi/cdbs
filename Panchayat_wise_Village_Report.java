...
public class Panchayat_wise_Village_Report extends JFrame implements ActionListener
{
	...
	ResultSet rs;
	int c;
	String []colname={"Panchayat Code","Panchayat Name","District Code","Subdivision Code","Block Code","Village Code","Village Name","Date Of Establishment","Mukhia Name"};
...
public Panchayat_wise_Village_Report()
{
		...
		lbl=new JLabel("Report of Panchayat Wise Village                                                 ");
		...
		rs=myStatement.executeQuery("select * from village_master");
		...
		{
		ResultSet rs1;
		rs1=myStatement.executeQuery("select p.panchayat_code,p.panchayat_name,v.district_code,v.subdiv_code,v.block_code,v.Village_code,v.village_name,to_char(v.estd,'DD-MON-YYYY'),v.mukhia_name from Panchayat_master p,village_master v where v.Panchayat_code=p.panchayat_code  order by v.district_code");
		for(int i=0;i<c;i++)
		{
		rs1.next();
