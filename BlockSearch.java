...
public class BlockSearch extends JFrame
  {

    private JLabel lblSbcd,lblDcd,lblBcode,lblestd,lblBname,lblmkname,lblBottom1,lblBottom2,lblHeader;
    private JTextField txtSbname,txtDname,txtBcode,txtestd,txtmkname,txtBname;
    private JPanel pnl;
    private JButton btnClose;
    Dimension screenSize;
    String st1,str1,str2,str3,str4,str5,str6,bc;
    Statement statement;
    Connection connection;
    ResultSet rs;

     public BlockSearch(String bcd)
      {
        bc=bcd;
        pnl = new JPanel();
       ...
       JLabel lblLine = new JLabel();
        ...
        setTitle("Search Result of Block Master");
        //setAlwaysOnTop(true);
 ...
 /* public void show()
  	...
  	private void search()
	{
			...
			try
			{
					...
					rs=statement.executeQuery("select District_code,Subdiv_code,Block_code,block_name,TO_CHAR(ESTD,'DD-MON-YYYY'),bdo_NAME from block_master where block_CODE='"+bc+"'");
					rs.next();
					str1=rs.getString(1);
					    str2=rs.getString(2);
					    str3=rs.getString(3);
				...
				/*	t4.setText(rs.getString(4));
			        ...
			        txtDname.setText(str1); 
			        txtBcode.setText(str3);
			        txtestd.setText(str5);
			        txtBname.setText(str4); 
			        txtmkname.setText(str6); 
    ...
    {
        BlockSearch bs = new BlockSearch("b025");
    }
