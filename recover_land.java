...
public class recover_land extends JFrame
{
	...
	Statement stat;
	ResultSet rs;
	private String str1,str2,str3,str4,str5,str6,str7,str8,str9,str10,tmp;
	String colhead[]={"Village_code","Individual_info_no","LAND_INFO_NO","LAND_IN_ACRE","IRRIGATED_LAND","NON_IRRIGATED_LAND","HOUSE_AREA","User","Status","Date of Modification"};
	...
	public recover_land()
	{
		...
		title=new JLabel("Recover land Information");
    	...
    	l1=new JLabel("Enter Land Info No");
		...
		load();
         ...
         public void load()
         {
            ...
            try
            {
              ...
              rs=stat.executeQuery("select Village_code,Individual_info_no,LAND_INFO_NO,LAND_IN_ACRE,IRRIGATED_LAND,NON_IRRIGATED_LAND,HOUSE_AREA,User_NAME,Status,TO_CHAR(dt,'DD-MON-YYYY') from bkp_land order by village_code");
              while(rs.next())
              {
                str1=rs.getString(1);
                str2=rs.getString(2);
   	...
   	private class okListener implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			try
			{
				  str1=t1.getText();
				  tmp="update";
				  rs=stat.executeQuery("select Village_code,Individual_info_no,LAND_IN_ACRE,IRRIGATED_LAND,NON_IRRIGATED_LAND,HOUSE_AREA,Status from bkp_land where land_info_no='"+str1.trim()+"'");
                 rs.next();
                str2=rs.getString(1);
                str3=rs.getString(2);
                str4=rs.getString(3);
                ...
                str7=rs.getString(6);
                str8=rs.getString(7);
                if(tmp.equals(str8.trim()))
                {
                	JOptionPane.showMessageDialog(null,"hello in try");
                //stat.executeUpdate("update land_INFO set Village_code='"+str2+"',Individual_info_no='"+str3+"',LAND_IN_ACRE='"+str4+"',IRRIGATED_LAND='"+str5+"',NON_IRRIGATED_LAND='"+str6+"',HOUSE_AREA='"+str7+"'  where land_info_no='"+str1.trim()+"'");
				stat.executeUpdate("update land_INFO set Village_code='"+str2+"',Individual_info_no='"+str3+"',LAND_IN_ACRE='"+str4+"'  where land_info_no='"+str1.trim()+"'");
				stat.executeUpdate("delete from bkp_land where land_info_no='"+str1.trim()+"'");
				stat.executeUpdate("commit");
